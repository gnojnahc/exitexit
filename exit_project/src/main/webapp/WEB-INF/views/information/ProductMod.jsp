    ...
    <body style="background-color: gray; font-size: 100%">
                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="form-submit-switch" action="/information/product/mod" method="post" onsubmit="">
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0" style="float: left; width: 380px">
                                                        <input class="form-control" id="inputcode" type="text" name="code" placeholder="자재코드" value="${vo.code}" />
                                                ...
                                                <div style="text-align:center;">
	                                                <div class="col-md-1-left">
	                                                    <div class="form-floating mb-3 mb-md-0" style="float: left; width: 48%;">
	                                                        <select class="dataTable-selector" id="selectinspect" name="inspect" style="width: 100%;" disabled>
	                                                ...
	                                                <div class="col-md-1-right">
	                                                    <div class="form-floating mb-3 mb-md-0" style="float: right; width: 48%;">
	                                                        <select class="dataTable-selector" id="selectdisuse" name="disuse" style="width: 100%;" disabled>
                                            ...
                                            <div class="mt-4 mb-0" style="text-align: right;">
                                                <button class="btn btn-primary" id="modify_sbm" type="button">완료</button>
        ...
        <script>
	        ...
	        $(document).on('click', '#searchcode', function (e){
				$('form').attr('action', '/information/product/modsearchcode').submit();
            });
	        ...
	        $(document).ready(function(){
	        	if(schack == "searchOK") {
	        		...
	        		$('#inputpurchasing').removeAttr('disabled');
	        		$('#inputpurchasingName').removeAttr('disabled');
	        		$('#inputbuyCompany').removeAttr('disabled');
	        		$('#inputbuyCompanyName').removeAttr('disabled');
	        		$('#inputinspectperson').removeAttr('disabled');
	        		$('#inputcurrentInventory').removeAttr('disabled');
	        ...
	        // 수정서브밋
	        $(document).on('click', '#modify_sbm', function (e){
