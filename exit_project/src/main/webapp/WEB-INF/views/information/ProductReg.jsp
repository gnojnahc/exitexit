                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-2"><b>검사 자재 등록</b></h3></div>
                                    <div class="card-body">
                                        ...
                                        <form action="/information/product/reg" method="post">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputcurrentInventory" type="text" name="currentInventory" placeholder="현재고" />
                                                        <label for="inputcurrentInventory">현재고</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputprice" type="text" name="price" placeholder="구매단가" />
                                                        <label for="inputprice">구매단가</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <select class="dataTable-selector" name="inspect" style="width: 45%;">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <select class="dataTable-selector" name="disuse" style="width: 45%;">
                                                        	<option value="N">N</option>
                                                        	<option value="Y">Y</option>
                                                        </select>
