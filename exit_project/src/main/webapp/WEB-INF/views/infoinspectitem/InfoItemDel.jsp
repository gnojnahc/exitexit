    ...
    <body style="background-color: gray; font-size: 100%">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-2"><b>자재별 검사항목 삭제</b></h3></div>
                                    <div class="card-body">
                                    
                                        <form class="form-submit-switch" action="/infoinspectitem/del" method="post" onsubmit="">
                                            <div class="row mb-3">
                                            
                                                                                         
	                                            <div class="col-md-6">
	                                                    <div class="form-floating mb-3 mb-md-0" style="float: left; width: 380px">
	                                                        <input class="form-control" id="inputcode" type="text" name="inputcode" placeholder="자재코드" value="${vo.code}" required/>
        ...
        <script>
	        ...
	        $(document).on('click', '#delsearch', function (e){
				$('form').attr('action', '/infoitem/infoitem/delsearch').submit();
            });
